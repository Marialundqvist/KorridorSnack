    ...
    <div class="content">
        ...
        <form method="POST" action="../auth/register">
            ...
            <div class="input-group input-group-lg">
                ...
                <input type="text" name="fname"  value="{{ old('fname') }}" class="form-control" placeholder="Förnamn" aria-describedby="sizing-addon1">
            </div>

              <div class="input-group input-group-lg">
                <span class="input-group-addon" id="sizing-addon2">E-mail </span>
                 <input type="email" name="email" value="{{ old('email') }}" class="form-control" placeholder="exempel@student.hh.se" aria-describedby="sizing-addon2">
            </div>
